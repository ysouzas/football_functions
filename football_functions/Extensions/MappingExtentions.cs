...
public static class MappingExtentions
{
    ...
    {
        return new PlayerDTO(me.Name, me.RowKey, ((decimal)me.Score), me.Position, me.AvoidSameTeam, me.NeedToBeAtSameTeam);
    }
    ...
    {
        return new PlayerInTeamDTO(me.Name, me.Id, (decimal)me.Score, me.Position);
    }
}
